...
class Sensor2Screen extends StatefulWidget {
  const Sensor2Screen({Key? key}) : super(key: key);
  @override
  State<Sensor2Screen> createState() => _Sensor2ScreenState();
}

class _Sensor2ScreenState extends State<Sensor2Screen> {
